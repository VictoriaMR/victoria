...
<body class="index">
    ...
    <div class="container">
        <div class="logo">
            <a href="{{$admin_url}}">Victoria</a></div>
        <div class="left_open">
            ...
            <ul id="nav">
                <li>
                    ...
                    <ul class="sub-menu">
                        ...
                        <li>
                            <a onclick="xadmin.add_tab('会员列表(静态表格)',ADMIN_URL + 'list')">
                                <i class="iconfont">&#xe6a7;</i>
                                <cite>会员列表(静态表格)</cite>
                            </a>
                        </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        <li>
                            <a onclick="xadmin.add_tab('管理员列表', ADMIN_URL + 'user/list')">
                                <i class="iconfont">&#xe6a7;</i>
                                <cite>管理员列表</cite></a>
                        </li>
                        <li>
        ...
        <div class="layui-tab tab" lay-filter="xbs_tab" lay-allowclose="false">
            ...
            <div class="layui-tab-content">
                <div class="layui-tab-item layui-show">
                    <iframe src="{{$admin_url}}overview" frameborder="0" scrolling="yes" class="x-iframe"></iframe>
                </div>
            </div>
            <div id="tab_show"></div>
        </div>
